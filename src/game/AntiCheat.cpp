...
bool AntiCheat::CheckTp2Plane()
{
    ...
    plane_z = GetMover()->GetTerrain()->GetHeight(GetMover()->GetPhaseMask(), m_currentmovementInfo->GetPos()->x, m_currentmovementInfo->GetPos()->y, MAX_HEIGHT) - m_currentmovementInfo->GetPos()->z;
